...
router.post('/pedido_detalle',verifyToken,async(req,res)=>{
...
router.put("/pedido_detalle/:id",verifyToken,async (req,res)=>{
...
router.delete("/pedido_detalle/:id",verifyToken,async (req,res)=>{
